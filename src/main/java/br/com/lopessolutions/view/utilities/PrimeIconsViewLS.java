 ...
 */
package br.com.lopessolutions.view.utilities;
...
@Named
@ApplicationScoped
public class PrimeIconsViewLS implements Serializable {
    ...
    public void init() {
        ...
        try {
            ...
            Logger.getLogger(PrimeIconsViewLS.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
