 ...
 */
package br.com.lopessolutions.blockviewer;
...
@FacesComponent(value="BlockViewerLS")
public class BlockViewerLS extends UINamingContainer implements Serializable {
