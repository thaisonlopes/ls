...
public class DataUtil {
	...
	public static String getDateParse(java.util.Date data) {
	...
	/*
	 * Retorna uma data no formato ##/##/#### com o mês e o ano passado como
	 * parâmetro e o dia 01
	 */
	public static java.sql.Date getData1DeJaneiro(int ano) {
	...
	/*
	 * Retorna uma data no formato ##/##/#### com o mês e o ano da data passada como
	 * parâmetro e o dia 01
	 */
	public static String getDataDiaInicialDoMes(String data) {
	...
	public static java.sql.Date getDataMinima() {
		return getDateSQL("01/01/1980");
	}

	public static java.sql.Date getDataMaxima() {
		return getDateSQL("31/12/2099");
	}

	/**
	 * Devolve true se data1 é de um dia inferior a data2 ou false caso contrário
	 *
	 * @param data1
	 * @param data2
	 * @return
	...
	public static java.sql.Date getUltimaDataAnoOrca(int anoOc) {
	...
	public static java.util.Date getDataAtualUtil() {
		java.util.Date data = new java.util.Date();
	...
	public static java.sql.Date recupDataDate(String data) {
	...
	public static java.sql.Date getData(int dia, int mes, int ano) {
	...
	private static int getDiaDaSemanaInt(int dia, int mes, int ano) {
	...
	public static String getDataDiaFinalDoMes(int mes, int ano) {
		...
		return TextoUtil.completaAEsquerda("" + numDias, 2, "0") + "/" + TextoUtil.completaAEsquerda(mes + "", 2, "0")
				+ "/" + ano;
	}

	public static java.sql.Date getDataDiaFinalDoMesSQL(int mes, int ano) {
	...
	public static boolean eSabadoOuDomingo(int dia, int mes, int ano) {
	...
	public static boolean eDiaUtil(int dia, int mes, int ano, boolean feriado) {
	...
	public static java.sql.Date getDataDiaAnteriorSql() {
		java.sql.Date data = getDataAtualSql();

		return getDataDiaAnteriorSql(data);
	}

	public static java.sql.Date getDataDiaAnteriorSql(java.util.Date data) {
		int dia = getDia(data);
	...
	private static String preencheData(int dia, int mes, int ano) {
		return TextoUtil.completaAEsquerda("" + dia, 2, "0") + "/" + TextoUtil.completaAEsquerda("" + mes, 2, "0") + "/"
				+ ano;
	}
